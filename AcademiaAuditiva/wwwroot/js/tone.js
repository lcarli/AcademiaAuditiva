            ...
            var i = function (t, e, s) {
              ...
              _ = function (t, e, s, n, i) {
                return void 0 === s
                  ...
                  : [s.startTime, f(t, e - 1, s.startTime, i)];
              },
              m = function (t) {
                  ...
                  [
                    ...
                    },
                    {
                      ...
                      value: function (t) {
                        var e = v(t);
                        if (m(t) || g(t)) {
                          var s = this._automationEvents.findIndex(function (
                              s
                            ) {
                              return g(t) && d(s)
                                ? s.startTime + s.duration >= e
                                : v(s) >= e;
                            }),
                          ...
                          if (
                            (-1 !== s &&
                              (this._automationEvents =
                                this._automationEvents.slice(0, s)),
                            m(t))
                          ) {
                            var c =
                              this._automationEvents[
                          ...
                          var M = this._automationEvents.findIndex(function (
                              t
                            ) {
                              return v(t) > e;
                            }),
                          ...
                          if (void 0 !== E && d(E) && v(E) + E.duration > e)
                            return !1;
                          var R = h(t)
                          ...
                          if (-1 === M) this._automationEvents.push(R);
                            ...
                            if (
                              d(t) &&
                              e + t.duration > v(this._automationEvents[M])
                            )
                              return !1;
                    ...
                    },
                    {
                      ...
                      value: function (t) {
                        ...
                        var s = this._automationEvents.findIndex(function (e) {
                          ...
                          n = this._automationEvents[s],
                          i =
                            (-1 === s ? this._automationEvents.length : s) - 1,
                          o = this._automationEvents[i];
                        if (
                          void 0 !== o &&
                          b(o) &&
                          (void 0 === n || !u(n) || n.insertTime > t)
                        )
                          return c(
                            t,
                            f(
                        ...
                        if (
                          ...
                          (void 0 === n ||
                            !u(n) ||
                            o.startTime + o.duration > t)
                        )
                          return t < o.startTime + o.duration
                            ? w(t, o)
                            : o.values[o.values.length - 1];
                        if (void 0 !== o && u(o) && (void 0 === n || !u(n)))
                          return o.value;
                        if (void 0 !== n && h(n)) {
                          var r = _(
                              this._automationEvents,
    ...
    return (
      (() => {
        ...
        const r = new WeakSet(),
          ...
          at = (t) => {
            ...
            (t.connect = (
              ...
              (s, n = 0, i = 0) => {
                ...
                return (
                  void 0 === r
                    ? e.set(s, [{ input: i, output: n }])
                    : r.every((t) => t.input !== i || t.output !== n) &&
                      r.push({ input: i, output: n }),
                  o
                );
              }
            )(t.connect.bind(t))),
              (t.disconnect = ((s) => (n, i, o) => {
                if ((s.apply(t), void 0 === n)) e.clear();
                  ...
                  if (void 0 === i) e.delete(n);
                    ...
                    if (void 0 !== t) {
                      const s = t.filter(
                        (t) => t.output !== i && (t.input !== o || void 0 === o)
                      );
                ...
                for (const [s, n] of e)
                  n.forEach((e) => {
                    rt(s)
                      ? t.connect(s, e.output, e.input)
                      : t.connect(s, e.output);
                  });
              })(t.disconnect));
          },
          ct = (t, e, s, n, i) => {
            const [o, r] = ((t, e, s, n) => {
              const { activeInputs: i, passiveInputs: o } = j(e),
                r = $(i[n], t, s);
              return null === r ? [T(o, t, s, n)[2], !1] : [r[2], !0];
            })(t, s, n, i);
            if (
              (null !== o &&
                (H(t, o), !r || e || st(t) || K(tt(t), tt(s), n, i)),
              N(s))
            ) {
          ...
          ht = (t, e, s, n) => {
            const [i, o] = ((t, e, s) => {
              const { activeInputs: n, passiveInputs: i } = L(e),
                o = $(n, t, s);
              return null === o ? [J(i, t, s)[1], !1] : [o[2], !0];
            })(t, s, n);
            null !== i &&
              (H(t, i), !o || e || st(t) || tt(t).disconnect(et(s), n));
          };
        class lt {
          constructor(t) {
            this._map = new Map(t);
        ...
        const dt = (t, e, s, n, i) => {
            "function" == typeof t.copyToChannel
              ? 0 !== e[s].byteLength && t.copyToChannel(e[s], n, i)
              : 0 !== e[s].byteLength && t.getChannelData(n).set(e[s], i);
          },
          ft = (t, e) => {
            const s = [];
            for (let n = 0; n < t; n += 1) {
          ...
          _t = async (t, e, s, n, i, o, r) => {
            ...
            for (let h = 0; h < a; h += 128) {
              ...
              try {
                const t = d.map((t, e) =>
                    0 === u.activeInputs[e].size ? [] : t
                  ),
                  e = r(h / s.sampleRate, s.sampleRate, () =>
                    p.process(t, f, m)
                  );
                if (null !== l)
          ...
          It = (t) => "function" == typeof t.getFloatTimeDomainData,
          Ft = (t, e, s) => {
            const n = e[s];
        ...
        const Qt = (t, e, s, n) => t.createScriptProcessor(e, s, n),
          ...
          ee = (t, e, s) =>
            void 0 === t.copyFromChannel
              ? t.getChannelData(s)[0]
              : (t.copyFromChannel(e, s), e[0]),
          se = (t) => {
            if (null === t) return !1;
            const e = t.length;
            return e % 2 != 0
          ...
          ue = (t, e) => (s) => {
            const n = { value: t };
            return (
              Object.defineProperties(s, { currentTarget: n, target: n }),
        ...
        const Ce = ((t) =>
            ...
            class {
              ...
              addEventListener(e, s, n) {
                if (null !== s) {
                  ...
                  void 0 === i &&
                    ((i = t(this, s)),
                    "function" == typeof s && this._listeners.set(s, i)),
          ...
          Fe = ((t) =>
            null === t
              ...
              ? t.AudioWorkletNode
              : null)(xe),
          Ve = ((t, e, s, n, i, o, r, a, h, l, u, d, f, _, m, g) =>
            class extends l {
              constructor(e, n, i, o) {
                    ...
                    const { activeInputs: i, passiveInputs: o } = L(e),
                      ...
                      c = (r) => {
                        ...
                        if (r) {
                          ...
                          const e = ((t, e, s) =>
                            b(t, (t) => t[0] === e && t[1] === s))(i, t, s);
                          Z(o, e, !1), n || st(t) || a.disconnect(c, s);
                        }
                      };
                    return (
                      !!G(r, [e, s], (t) => t[0] === e && t[1] === s, !0) &&
                      (a.add(c),
                      N(t) ? Q(i, t, [s, c], !0) : Z(o, [t, s, c], !0),
                      !0)
                    );
                  })(this, t, s, l)
                ) {
                ...
                if (void 0 === t)
                  n = ((t, e) => {
                    ...
                    for (const i of s.outputs)
                      U(i) ? ct(t, e, ...i) : ht(t, e, ...i), n.push(i[0]);
                  ...
                  if (void 0 !== e && (e < 0 || e >= this.numberOfOutputs))
                    throw i();
                  if (B(t) && void 0 !== s && (s < 0 || s >= t.numberOfInputs))
                    throw i();
                  if (
                    ((n = ((t, e, s, n, i) => {
                      const o = j(t);
            ...
            ((t, e, s, n, i, o, r, a, c, h, l, u, p) => {
              const d = new WeakMap();
              return (f, _, m, g, v) => {
                const { activeInputs: y, passiveInputs: x } = o(_),
                  { outputs: w } = o(f),
                  b = a(f),
                  S = (o) => {
                    const a = c(_),
                ...
                return (
                  ...
                  (b.add(S),
                  l(f) ? t(y, f, [m, g, S], !0) : e(x, g, [f, m, S], !0),
                  !0)
                );
              };
            })(pe, de, Y, fe, K, j, me, S, tt, G, N, st, nt),
            ge,
            ((t, e, s, n, i, o) => (r) => (a, c) => {
              const h = t.get(a);
              if (void 0 === h) {
            ...
            class extends t {
              ...
              set maxDecibels(t) {
                ...
                if (
                  ...
                  throw ((this._nativeAnalyserNode.maxDecibels = e), s());
              }
              get minDecibels() {
              ...
              set minDecibels(t) {
                ...
                if (
                  ...
                  throw ((this._nativeAnalyserNode.minDecibels = e), s());
              }
        ...
        const Be = ((t, e) => (s) => {
            (s.copyFromChannel = (n, i, o = 0) => {
              ...
              const c = s.length,
                ...
                l = n.length;
              for (let t = r < 0 ? -r : 0; t + r < c && t < l; t += 1)
                n[t] = h[t + r];
            }),
          ...
          Ge = ((t, e, s, n, i, o, r, a) => {
            ...
            return class h {
              constructor(h) {
                ...
                const d =
                  null !== n && e(o, o)
                    ? new n({ length: l, numberOfChannels: u, sampleRate: p })
          ...
          Ze = ((t, e, s) => async (n, i, o) => {
            const r = e(n);
            await Promise.all(
              Array.from(r.activeInputs).map(async ([e, n]) => {
                const r = t(e),
          ...
          $e = ((t, e) => (s, n, i) => (t(n).replay(i), e(n, s, i)))(
            ((t) => (e) => {
              const s = t(e);
              if (null === s.renderer)
                throw new Error(
                ...
                return void 0 !== l
                  ...
                  : (async (c, h) => {
                      ...
                      return (
                        o.set(h, l),
                        u
                          ? await t(h, c.playbackRate, l.playbackRate)
                          : await n(h, c.playbackRate, l.playbackRate),
                        await i(c, h, l),
                        l
                      );
                    })(c, h);
          ...
          Je = (
                        ...
                        for (const s of t)
                          if ("exponentialRampToValue" === s.type) {
                            ...
                            if ("setValueCurve" !== s.type)
                              throw new Error(
                                "Can't apply an unknown automation."
                              );
                            {
                              const {
                                duration: t,
                ...
                w = {
                  ...
                  cancelAndHoldAtTime(t) {
                    if ("function" == typeof _.cancelAndHoldAtTime)
                      null === x && y.flush(n.context.currentTime),
                        y.add(i(t)),
                  ...
                  exponentialRampToValueAtTime(t, e) {
                    ...
                    return (
                      null === x && y.flush(s),
                      0 === Array.from(y).length &&
                        (y.add(l(v, s)), _.setValueAtTime(v, s)),
                      y.add(a(t, e)),
            ...
            l,
            0,
            o.createCancelAndHoldAutomationEvent,
            o.createCancelScheduledValuesAutomationEvent,
            o.createExponentialRampToValueAutomationEvent,
            o.createLinearRampToValueAutomationEvent,
            o.createSetTargetAutomationEvent,
            o.createSetValueAutomationEvent,
            o.createSetValueCurveAutomationEvent,
            Ee,
            ie
          );
        var Ke;
        const ts = ((t, e, s, n, i, o, r, a) =>
            class extends t {
              constructor(t, n) {
                const a = o(t),
                  c = { ...P, ...n },
                ...
                super(t, !1, h, u),
                  ...
                  (this._onended = null),
                  (this._playbackRate = s(this, l, h.playbackRate, V, F));
              }
              get buffer() {
              ...
              start(t = 0, e = 0, s) {
                if (
                  ...
                  this._nativeAudioBufferSourceNode.addEventListener(
                    "ended",
                    t
                  );
                }
          ...
          es = ((t, e, s, n, i, o, r, a) =>
            ...
            ((t, e) => (s, n, i) => {
              ...
              i &&
                ...
                0 === o.maxChannelCount &&
                  Object.defineProperty(o, "maxChannelCount", { value: n });
              const r = t(s, {
                channelCount: n,
                ...
                return void 0 !== c
                  ...
                  : (async (r, a) => {
                      ...
                      return (
                        ...
                        h
                          ? (await t(a, r.Q, c.Q),
                            await t(a, r.detune, c.detune),
                            await t(a, r.frequency, c.frequency),
                            await t(a, r.gain, c.gain))
                          : (await n(a, r.Q, c.Q),
                            await n(a, r.detune, c.detune),
                            await n(a, r.frequency, c.frequency),
                            await n(a, r.gain, c.gain)),
                        await i(r, a, c),
                        c
                      );
                    })(r, a);
            ...
            class extends t {
              constructor(t, n) {
                ...
                super(t, !1, l, u ? s() : null),
                  ...
                  (this._gain = e(this, u, l.gain, 40 * Math.log10(V), F)),
          ...
          as = ((t, e) => (s, n) => {
            ...
            return (
              null !== t && "webkitAudioContext" === t.name && e(s, i),
              qt(i, n),
              i
            );
          })(Ee, rs),
          ...
          us = ((t, e, s, n, i, o) =>
            class extends t {
              constructor(t, o) {
                const r = n(t),
                  a = ((t) => ({ ...t, channelCount: t.numberOfOutputs }))({
                    ...vt,
                    ...o,
                  });
                super(t, !1, s(r, a), i(r) ? e() : null);
          ...
          ps = (
            ...
            (i, { offset: o, ...r }) => {
              ...
              const u = {
                ...
                addEventListener: (...t) =>
                  c.addEventListener(t[0], t[1], t[2]),
                dispatchEvent: (...t) => c.dispatchEvent(t[0]),
                removeEventListener: (...t) =>
                  c.removeEventListener(t[0], t[1], t[2]),
                start(t = 0) {
                  c.start.call(c, t);
                },
                stop(t = 0) {
                ...
                return void 0 !== l
                  ...
                  : (async (c, h) => {
                      ...
                      return (
                        o.set(h, l),
                        u
                          ? await t(h, c.offset, l.offset)
                          : await n(h, c.offset, l.offset),
                        await i(c, h, l),
                        l
                      );
                    })(c, h);
            ...
            class extends t {
              constructor(t, r) {
                ...
                super(t, !1, h, u),
                  ...
                  (this._offset = e(this, l, h.offset, V, F)),
                  (this._onended = null);
              }
              get offset() {
                return this._offset;
          ...
          ms = ((t, e) => (s, n) => {
            ...
            if (
              (qt(i, n),
              n.disableNormalization === i.normalize &&
                (i.normalize = !n.disableNormalization),
              Rt(i, n, "buffer"),
              n.channelCount > 2)
            )
              throw t();
                ...
                return void 0 !== h
                  ...
                  : (async (a, c) => {
                      ...
                      return (
                        r.set(c, h),
                        l
                          ? await t(c, a.delayTime, h.delayTime)
                ...
                return void 0 !== c
                  ...
                  : (async (r, a) => {
                      ...
                      return (
                        o.set(a, c),
                        h
                          ? (await t(a, r.attack, c.attack),
                            await t(a, r.knee, c.knee),
                            await t(a, r.ratio, c.ratio),
                            await t(a, r.release, c.release),
                            await t(a, r.threshold, c.threshold))
                          : (await n(a, r.attack, c.attack),
                            await n(a, r.knee, c.knee),
                            await n(a, r.ratio, c.ratio),
                            await n(a, r.release, c.release),
                            await n(a, r.threshold, c.threshold)),
                        await i(r, a, c),
                        c
                      );
                    })(r, a);
            ...
            class extends t {
              constructor(t, r) {
                ...
                super(t, !1, h, l ? s() : null),
                  (this._gain = e(this, l, h.gain, V, F));
              }
              get gain() {
                return this._gain;
              }
              ...
              return zt(
                {
                  ...
                  addEventListener: (...t) =>
                    g.addEventListener(t[0], t[1], t[2]),
                  ...
                  removeEventListener: (...t) =>
                    g.removeEventListener(t[0], t[1], t[2]),
                },
                g
              );
            }
                      ...
                      x = (e, n, o) => {
                        ...
                        return (
                          ...
                          (l.exponentialRampToValueAtTime =
                            ((_ = l.exponentialRampToValueAtTime),
                            d
                              ? () => {
                                  throw i();
                                }
                ...
                return void 0 !== u
                  ...
                  : (async (h, l) => {
                      ...
                      return (
                        o.set(l, u),
                        p
                          ? (await t(l, h.detune, u.detune),
                            await t(l, h.frequency, u.frequency))
                          : (await n(l, h.detune, u.detune),
                            await n(l, h.frequency, u.frequency)),
                        await i(h, l, u),
                        u
                      );
                    })(h, l);
          ...
          Ps = (
            ...
            (o, { curve: r, oversample: a, ...c }) => {
              ...
              const v = {
                ...
                addEventListener: (...t) =>
                  u.addEventListener(t[0], t[1], t[2]),
              ...
              return (
                ...
                h(
                  ...
                  () => {
                    D.connect(A),
                      t(D, N, 0, 0),
                      N.connect(M).connect(O, 0, 0),
                      N.connect(E).connect(O, 0, 1),
                      N.connect(R).connect(O, 0, 2),
                      N.connect(q).connect(O, 0, 3),
                      N.connect(I).connect(O, 0, 4),
                      N.connect(F).connect(O, 0, 5),
                      O.connect(V).connect(l.destination);
                  },
                  () => {
                    D.disconnect(A),
                      a(D, N, 0, 0),
          ...
          zs = ((t) => (e, s) => {
            ...
            return void 0 === n.orientationX
              ...
              : (qt(n, s),
                ...
                Ft(n, s, "positionY"),
                Ft(n, s, "positionZ"),
                Rt(n, s, "coneInnerAngle"),
                Rt(n, s, "coneOuterAngle"),
                Rt(n, s, "coneOuterGain"),
                Rt(n, s, "distanceModel"),
                Rt(n, s, "maxDistance"),
                Rt(n, s, "panningModel"),
                Rt(n, s, "refDistance"),
                Rt(n, s, "rolloffFactor"),
                n);
          })(Ls),
              ...
              render(p, d) {
                ...
                return void 0 !== f
                  ...
                  : (async (p, d) => {
                      ...
                      return (
                        v
                          ? (await t(d, p.orientationX, _.orientationX),
                            await t(d, p.orientationY, _.orientationY),
                            await t(d, p.orientationZ, _.orientationZ),
                            await t(d, p.positionX, _.positionX),
                            await t(d, p.positionY, _.positionY),
                            await t(d, p.positionZ, _.positionZ))
                          : (await a(d, p.orientationX, _.orientationX),
                            await a(d, p.orientationY, _.orientationY),
                            await a(d, p.orientationZ, _.orientationZ),
                            await a(d, p.positionX, _.positionX),
                            await a(d, p.positionY, _.positionY),
                            await a(d, p.positionZ, _.positionZ)),
            ...
            class extends t {
              constructor(t, a) {
                ...
                super(t, !1, l, u ? n() : null),
                  ...
                  (this._orientationX = e(this, u, l.orientationX, V, F)),
                  (this._orientationY = e(this, u, l.orientationY, V, F)),
                  (this._orientationZ = e(this, u, l.orientationZ, V, F)),
                  (this._positionX = e(this, u, l.positionX, V, F)),
                  (this._positionY = e(this, u, l.positionY, V, F)),
                  (this._positionZ = e(this, u, l.positionZ, V, F)),
                  r(this, 1);
              }
              get coneInnerAngle() {
          ...
          Us = (
            (t) =>
            (e, { disableNormalization: s, imag: n, real: i }) => {
          ...
          Qs = ((t, e, s, n, i, o) => {
            ...
            return (
              e,
              { channelCount: n, channelCountMode: r, pan: a, ...c }
            ) => {
              if ("max" === r) throw i();
              const h = t(e, {
                  ...c,
              ...
              Object.defineProperty(p.gain, "defaultValue", { get: () => 0 }),
                Object.defineProperty(p.gain, "maxValue", { get: () => 1 }),
                Object.defineProperty(p.gain, "minValue", { get: () => -1 });
              const _ = {
                get bufferSize() {},
                get channelCount() {
                ...
                set channelCount(t) {
                  l.channelCount !== t &&
                    (m && f(),
                    ({ connectGraph: d, disconnectGraph: f } = u(
                      e,
                      t,
                      l,
                      p,
                ...
                addEventListener: (...t) =>
                  l.addEventListener(t[0], t[1], t[2]),
          ...
          Ks = ((t) => (e, s, n) => {
            Object.defineProperties(t, {
              currentFrame: { configurable: !0, get: () => Math.round(e * s) },
          ...
          sn = Js
            ? ((t, e, s, n, i, o, r, a, c, h, l, u, p) => {
                ...
                return (_, m, g = { credentials: "omit" }) => {
                  ...
                  const T = o(_),
                    S =
                      void 0 === T.audioWorklet
                        ? i(m)
                            .then(([t, e]) => {
                              const [n, i] = v(t, e);
                              return s(
                                `${n};((a,b)=>{(a[b]=a[b]||[]).push((AudioWorkletProcessor,global,registerProcessor,sampleRate,self,window)=>{${i}\n})})(window,'_AWGS')`
                              );
                            })
                            .then(() => {
                              const t = p._AWGS.pop();
                              if (void 0 === t) throw new SyntaxError();
                              n(T.currentTime, T.sampleRate, () =>
                                t(
                                  class {},
                                  void 0,
                                  (t, s) => {
                  ...
                  return (
                    void 0 === b ? h.set(_, new Map([[m, S]])) : b.set(m, S),
                    S.then(() => {
                      const t = l.get(_);
              ...
              : new Promise((e, s) => {
                  ...
                  try {
                    u.decodeAudioData(
                      ...
                      (t) => {
                        o(
                          null === t ? new DOMException("", "EncodingError") : t
                        );
                      }
                    );
                  } catch (t) {
          ...
          rn = ((t, e, s, n, i, o, r, a, c, h, l, u, p, d, f, _, m, g, v, y) =>
            class extends f {
              constructor(e, s) {
                super(e, s),
              ...
              decodeAudioData(t, e, s) {
                return h(this._nativeContext, t).then(
          ...
          an = ((t, e, s, n) =>
            class extends t {
              constructor(t, e) {
                const i = s(t),
                  o = ((t, e) => t.createMediaElementSource(e.mediaElement))(
                    i,
                    e
                  );
              ...
              constructor(t, e) {
                ...
                const o = ((t, e) => {
                  ...
                  return (
                    qt(s, e),
                    1 === s.numberOfOutputs &&
                      Object.defineProperty(s, "numberOfOutputs", {
                        get: () => 0,
                      }),
                    s
                  );
              ...
              constructor(t, e) {
                const i = s(t),
                  o = ((t, { mediaStream: e }) => {
                    ...
                    return (
                      Object.defineProperty(i, "mediaStream", { value: e }), i
                    );
                  })(i, e);
                if (n(i)) throw new TypeError();
                super(t, !0, o, null),
          ...
          pn = ((t, e, s, n, i, o, r, a, c) =>
            class extends t {
              constructor(t = {}) {
                if (null === c)
                  throw new Error(
                    "Missing the native AudioContext constructor."
                  );
                let e;
                try {
                  e = new c(t);
                  ...
                  if (
                    12 === t.code &&
                    "sampleRate is not in range" === t.message
                  )
                    throw s();
                  throw t;
                }
                  ...
                  ((this._baseLatency =
                    "number" == typeof e.baseLatency
                      ...
                      : (128 *
                          Math.max(
                            2,
                            Math.min(128, Math.round((i * o) / 128))
                          )) /
                        o),
              ...
              resume() {
                return "suspended" === this._state
                  ? new Promise((t, e) => {
                      ...
                      this._nativeAudioContext.addEventListener(
                        "statechange",
                        s
                      );
                    })
            ...
            (e, s = void 0, n = void 0, i = 0) =>
              void 0 === s
                ...
                ? void 0 === n
                  ...
                  : void 0 === i
                  ? Tt(t, e, n).disconnect(s, 0)
                  : Tt(t, e, n).disconnect(s, 0, i)
                : void 0 === n
                ? e.forEach((t) => t.disconnect(s))
                : Tt(t, e, n).disconnect(s, 0)
          )(R),
          ...
          xn = ((t, e, s, n, i, o, r, a, c, h, l, u, p) => (d, f, m, g) => {
            ...
            const v = Array.isArray(g.outputChannelCount)
            ...
            if (void 0 !== m.parameterDescriptors)
              for (const {
                ...
                Object.defineProperties(i.offset, {
                  ...
                  maxValue: { get: () => (void 0 === e ? V : e) },
                  minValue: { get: () => (void 0 === s ? F : s) },
                }),
                  k.push(i);
              }
            const A = n(d, {
            ...
            for (let t = 0; t < g.numberOfInputs; t += 1) {
              ...
              for (let e = 0; e < g.channelCount; e += 1)
                S[t].connect(A, e, t * g.channelCount + e);
            }
            const E = new lt(
              void 0 === m.parameterDescriptors
                ? []
            ...
            const I = 0 === g.numberOfOutputs ? [O] : M,
              N = {
                ...
                set onprocessorerror(t) {
                  "function" == typeof q &&
                    N.removeEventListener("processorerror", q),
                    (q = "function" == typeof t ? t : null),
                    "function" == typeof q &&
                      N.addEventListener("processorerror", q);
                },
                get parameters() {
                  return E;
                },
            ...
            Object.defineProperty(b.port1, "onmessage", {
              ...
              set: (t) => {
                "function" == typeof z &&
                  b.port1.removeEventListener("message", z),
                  (z = "function" == typeof t ? t : null),
                  "function" == typeof z &&
                    (b.port1.addEventListener("message", z), b.port1.start());
              },
            }),
                ...
                for (let n = 0; n < C; n += 128) {
                  for (let e = 0; e < g.numberOfInputs; e += 1)
                    for (let s = 0; s < g.channelCount; s += 1)
                      pt(t, U[e], s, s, n);
                  void 0 !== m.parameterDescriptors &&
                    m.parameterDescriptors.forEach(({ name: e }, s) => {
                      pt(t, Q, e, y + s, n);
                    });
                  for (let t = 0; t < g.numberOfInputs; t += 1)
                    for (let e = 0; e < v[t]; e += 1)
                      0 === G[t][e].byteLength &&
                        (G[t][e] = new Float32Array(128));
                  try {
                    const t = U.map((t, e) => {
                        ...
                        return void 0 === n
                          ...
                          : (t.every((t) => t.every((t) => 0 === t)) &&
                              (1 === n ? Y.delete(e) : Y.set(e, n - 1)),
                            t);
                      }),
                      i = l(
                        d.currentTime + n / d.sampleRate,
                        d.sampleRate,
                        () => W.process(t, G, Q)
                      );
                    Z = i;
                  ...
                  if (!Z) {
                    for (let t = 0; t < g.numberOfInputs; t += 1) {
                      T[t].disconnect(S[t]);
                      for (let e = 0; e < g.channelCount; e += 1)
                        S[n].disconnect(A, e, t * g.channelCount + e);
                    }
                    if (void 0 !== m.parameterDescriptors) {
                ...
                if (
                  (Object.defineProperties(e, {
                    ...
                    onprocessorerror: {
                      ...
                      set: (t) => {
                        "function" == typeof r &&
                          e.removeEventListener("processorerror", r),
                          (r = "function" == typeof t ? t : null),
                          "function" == typeof r &&
                            e.addEventListener("processorerror", r);
                      },
                    },
                  }),
                  (e.addEventListener =
          ...
          bn = (
            (t, e, s, n, i, o, r, a, c, h, l, u, p, d, f, _) => (m, g, v) => {
              const y = new WeakMap();
              let x = null;
              return {
                render(w, b) {
                    ...
                    : (async (a, w) => {
                        ...
                        if ((y.set(w, null === T ? b : T[2]), null !== T)) {
                          if (null === x) {
                            if (void 0 === v)
                              throw new Error(
                                "Missing the processor constructor."
                              );
                            if (null === p)
                              throw new Error(
                                "Missing the native OfflineAudioContext constructor."
                            ...
                            const t = a.channelCount * a.numberOfInputs,
                              ...
                              c = async () => {
                                ...
                                for (let t = 0; t < g.numberOfInputs; t += 1) {
                                  h[t].connect(l[t]);
                                  for (let e = 0; e < g.channelCount; e += 1)
                                    l[t].connect(m, e, t * g.channelCount + e);
                                }
                                for (const [e, s] of u.entries())
                                  s.connect(m, 0, t + e), s.start(0);
                                return (
                        ...
                        if (S)
                          for (const [e, s] of a.parameters.entries())
                            await t(w, s, b.parameters.get(e));
                        else
                          for (const [t, e] of a.parameters.entries())
                            await d(w, e, b.parameters.get(t));
          ...
          kn = Js
            ? ((t, e, s, n, i, o, r, a, c, h, l, u, p, d) =>
                ...
                })(fn, Ve, Je, bn, wn, j, Tn, ke, Oe, Fe, 0, Sn, 0, ue)
            : void 0,
          An = ((t, e) => (s, n, i) => {
            if (null === e)
              throw new Error(
          ...
          Cn = (
            (t, e, s, n, i, o, r, a) => (c, h) =>
              s(c)
                .render(c, h)
                .then(() =>
                  Promise.all(Array.from(n(h)).map((t) => s(t).render(t, h)))
                )
                .then(() => i(h))
                .then(
                  (s) => (
          ...
          )(je, ge, be, dn, Cs, E, Be, Ue),
          On = ((t, e, s, n, i) =>
            class extends t {
              constructor(t, s, i) {
                let o;
                if ("number" == typeof t && void 0 !== s && void 0 !== i)
                  o = { length: s, numberOfChannels: t, sampleRate: i };
                else {
                  if ("object" != typeof t)
                  ...
                  h.addEventListener(
                    ...
                    (() => {
                      ...
                      const e = (s) => {
                        "running" === this._state &&
                          (t > 0
                            ? (h.removeEventListener("statechange", e),
                              s.stopImmediatePropagation(),
                              this._waitForThePromiseToSettle(s))
                            : (t += 1));
                      };
                      return e;
                    })()
              ...
              startRendering() {
                return "running" === this._state
                  ...
                  : ((this._state = "running"),
                    i(
                      this.destination,
                      this._nativeOfflineAudioContext
                    ).finally(() => {
          ...
          qn = () =>
            (async (t, e, s, n, i, o, r, a, c, h, l, u, p, d, f, _) =>
              !!(
                t(e, e) &&
                t(s, s) &&
                t(i, i) &&
              ...
              (await Promise.all([t(n, n), t(r, r), t(f, f), t(_, _)])).every(
                (t) => t
              ))(
              ge,
              ((t) => () => {
              ...
              ((t) => () => {
                ...
                return new Promise((t) => {
                  ...
                  const n = (n) => {
                    s &&
                      ((s = !1), e.startRendering(), t(n instanceof TypeError));
                  };
                  let i;
                  try {
              ...
              ((t, e) => async () => {
                ...
                try {
                  ...
                  await new Promise((t) => {
                    (e.port.onmessage = () => t()),
                      e.port.postMessage(n.port2, [n.port2]);
                  }),
              ...
              ((t) => () => {
                ...
                return (
                  ...
                  e.createConstantSource().offset.maxValue !==
              ...
              (
                (t) => () =>
                  null !== t && t.hasOwnProperty("isSecureContext")
              )(xe),
              ((t) => () => {
                if (null === t) return !1;
                const e = new t();
        ...
        function Un(t, e, s = 1 / 0) {
          if (!(e <= t && t <= s))
            throw new RangeError(
              `Value must be within [${e}, ${s}], got: ${t}`
            );
        }
        function Gn(t) {
          t.isOffline ||
        ...
        const ti = "object" == typeof self ? self : null,
          ei =
            ti &&
            (ti.hasOwnProperty("AudioContext") ||
              ti.hasOwnProperty("webkitAudioContext"));
        function si(t, e, s, n) {
          var i,
            o = arguments.length,
            r =
          ...
          set updateInterval(t) {
            ...
            (this._updateInterval = Math.max(t, this._minimumUpdateInterval)),
              "worker" === this._type &&
                (null === (e = this._worker) ||
                  void 0 === e ||
                  e.postMessage(1e3 * this._updateInterval));
          }
          get type() {
            return this._type;
          }
          ...
          if (Pn(t) && Pn(s))
            for (const e in s)
              hi(e, s[e])
                ? (t[e] = s[e])
                : Pn(s[e])
                ? (t[e] || Object.assign(t, { [e]: {} }), li(t[e], s[e]))
                : Object.assign(t, { [e]: s[e] });
          return li(t, ...e);
        }
        function ui(t, e, s = [], n) {
          const i = {},
          ...
          if (
            (Pn(o[0]) &&
              ...
              (Object.keys(o[0]).some((e) => Reflect.has(t, e)) ||
                (li(i, { [n]: o[0] }), s.splice(s.indexOf(n), 1), o.shift())),
            1 === o.length && Pn(o[0]))
          )
            li(i, o[0]);
          else for (let t = 0; t < s.length; t++) Fn(o[t]) && (i[s[t]] = o[t]);
          return li(t, i);
        }
        function pi(t, e) {
          return In(t) ? e : t;
        ...
        class fi {
          ...
          log(...t) {
            (this.debug || (ti && this.toString() === ti.TONE_DEBUG_CLASS)) &&
              Jn(this, ...t);
          }
          dispose() {
        ...
        class wi extends fi {
            ...
            if (this._timeline.length > 1) {
              ...
              if (e >= 0)
                if (yi(this._timeline[e].time, t)) {
                  for (let s = e; s >= 0 && yi(this._timeline[s].time, t); s--)
                    e = s;
          ...
          _search(t, e = "time") {
            ...
            for (; s < i; ) {
              ...
              if (yi(o[e], t)) {
                for (
                  let s = n;
                  s < this._timeline.length && yi(this._timeline[s][e], t);
                  s++
                )
                  n = s;
                return n;
          ...
          forEachAtTime(t, e) {
            ...
            if (-1 !== s && yi(this._timeline[s].time, t)) {
              let n = s;
              for (let e = s; e >= 0 && yi(this._timeline[e].time, t); e--)
                n = e;
              this._iterate(
                (t) => {
                  e(t);
        ...
        class Oi extends Ci {
          ...
          initialize() {
            ...
            return (
              this._initialized ||
                ((t = this), bi.forEach((e) => e(t)), (this._initialized = !0)),
              this
            );
          }
          createAnalyser() {
          ...
          createMediaStreamSource(t) {
            return (
              Bn(ci(this._context), "Not available if OfflineAudioContext"),
          ...
          createAudioWorkletNode(t, e) {
            return (function (t, e, s) {
              return (
                ...
                new (t instanceof (null == ti ? void 0 : ti.BaseAudioContext)
                  ? null == ti
                    ? void 0
                    : ti.AudioWorkletNode
                  : kn)(t, e, s)
          ...
          addAudioWorkletModule(t) {
            return ni(this, void 0, void 0, function* () {
              Bn(
                Fn(this.rawContext.audioWorklet),
        ...
        class Ri extends fi {
          constructor() {
            ...
            (this.reverse = t.reverse),
              ...
              zn(t.url)
                ? this.load(t.url).catch(t.onerror)
                : t.url && this.set(t.url);
          }
          static getDefaults() {
            return { onerror: Ei, onload: Ei, reverse: !1 };
          }
          get sampleRate() {
          ...
          static load(t) {
            return ni(this, void 0, void 0, function* () {
              ...
              const s =
                  "" === Ri.baseUrl || Ri.baseUrl.endsWith("/")
                    ? Ri.baseUrl
                    : Ri.baseUrl + "/",
                n = document.createElement("a");
              (n.href = s + t),
                (n.pathname = (n.pathname + n.hash)
                  .split("/")
          ...
          static supportsType(t) {
            const e = t.split("."),
              s = e[e.length - 1];
            return (
              "" !== document.createElement("audio").canPlayType("audio/" + s)
            );
          }
          static loaded() {
            return ni(this, void 0, void 0, function* () {
              for (yield Promise.resolve(); Ri.downloads.length; )
                yield Ri.downloads[0];
            });
          }
        }
        ...
        class Qi extends fi {
          ...
          _getExpressions() {
            return {
              ...
              m: {
                method: (t) =>
                  this._beatsToUnits(
                    parseInt(t, 10) * this._getTimeSignature()
                  ),
                regexp: /^(\d+)m$/i,
              },
              n: {
              ...
              tr: {
                method: (t, e, s) => {
                  ...
                  return (
                    ...
                    s &&
                      "0" !== s &&
                      (n += this._beatsToUnits(parseFloat(s) / 4)),
                    n
                  );
                },
                regexp: /^(\d+(?:\.\d+)?):(\d+(?:\.\d+)?):?(\d+(?:\.\d+)?)?$/,
          ...
          valueOf() {
            if (
              (this._val instanceof Qi && this.fromType(this._val),
              In(this._val))
            )
              return this._noArg();
            ...
            return (
              Object.keys(t).forEach((e) => {
                if (Reflect.has(this, e)) {
                  const s = this[e];
                  Fn(s) && Fn(s.value) && Fn(s.setValueAtTime)
                    ? (t[e] = s.value)
                    : s instanceof eo
          ...
          set(t) {
            return (
              Object.keys(t).forEach((e) => {
                Reflect.has(this, e) &&
                  Fn(this[e]) &&
                  (this[e] && Fn(this[e].value) && Fn(this[e].setValueAtTime)
                    ? this[e].value !== t[e] && (this[e].value = t[e])
                    : this[e] instanceof eo
                    ? this[e].set(t[e])
                    : (this[e] = t[e]));
              }),
              this
        ...
        class no extends eo {
          constructor() {
            ...
            for (
              super(t),
                ...
                Bn(
                  Fn(t.param) && (oi(t.param) || t.param instanceof no),
            ...
            (this._swappable = !!Fn(t.swappable) && t.swappable),
              this._swappable
                ? ((this.input = this.context.createGain()),
                  (this._param = t.param),
                  this.input.connect(this._param))
                : (this._param = this.input = t.param),
              (this._events = new wi(1e3)),
          ...
          getValueAtTime(t) {
            ...
            if (null === n) i = this._initialValue;
              ...
              "setTargetAtTime" !== n.type ||
              (null !== s && "setValueAtTime" !== s.type)
            )
              if (null === s) i = n.value;
              else if (
                ...
                i =
                  "linearRampToValueAtTime" === s.type
                    ? this._linearInterpolate(n.time, t, s.time, s.value, e)
          ...
          cancelScheduledValues(t) {
            ...
            return (
              Bn(
                isFinite(e),
                `Invalid argument to cancelScheduledValues: ${JSON.stringify(
                  t
                )}`
              ),
        ...
        class io extends eo {
          ...
          get numberOfInputs() {
            return Fn(this.input)
              ? oi(this.input) || this.input instanceof no
                ? 1
          ...
          set channelCountMode(t) {
            ...
            this._setChannelProperties(
              Object.assign(e, { channelCountMode: t })
            );
          }
          get channelInterpretation() {
          ...
          toMaster() {
            return (
              Kn("toMaster() has been renamed toDestination()"),
              this.toDestination()
            );
          }
          ...
          dispose() {
            return (
              super.dispose(),
              Fn(this.input) &&
                (this.input instanceof io
                  ? this.input.dispose()
                  : ri(this.input) && this.input.disconnect()),
              Fn(this.output) &&
                (this.output instanceof io
                  ? this.output.dispose()
                  : ri(this.output) && this.output.disconnect()),
        ...
        function oo(...t) {
          const e = t.shift();
          t.reduce(
            (t, e) => (t instanceof io ? t.connect(e) : ri(t) && ro(t, e), e),
            e
          );
        }
        function ro(t, e, s = 0, n = 0) {
          for (
            Bn(Fn(t), "Cannot connect from undefined node"),
              Bn(Fn(e), "Cannot connect to undefined node"),
              (e instanceof io || ri(e)) &&
                Bn(
                  e.numberOfInputs > 0,
        ...
        class lo extends io {
          constructor(t) {
            super(t),
              ...
              (this._stopTime = -1),
              (this._timeout = -1),
              (this.output = new ho({ context: this.context, gain: 0 })),
          ...
          _onended() {
            if (
              this.onended !== Ei &&
              (this.onended(this), (this.onended = Ei), !this.context.isOffline)
            ) {
        ...
        function fo(t, e, s, n) {
          (e instanceof no || oi(e) || (e instanceof po && e.override)) &&
            (e.cancelScheduledValues(0),
            e.setValueAtTime(0, 0),
            e instanceof po && (e.overridden = !0)),
            ro(t, e, s, n);
        }
        class _o extends no {
          constructor() {
          ...
          _getTicksUntilEvent(t, e) {
            ...
            return (
              i &&
                ...
                (n = this._fromType(this.getValueAtTime(e - this.sampleTime))),
          ...
          getTimeOfTick(t) {
            ...
            if (
              ...
              const n = this._fromType(this.getValueAtTime(e.time)),
                i =
                  (this._fromType(this.getValueAtTime(s.time)) - n) /
                  (s.time - e.time),
        ...
        class go extends eo {
          ...
          start(t, e) {
            ...
            return (
              "started" !== this._state.getValueAtTime(s) &&
                (this._state.setStateAtTime("started", s),
                Fn(e) && this.setTicksAtTime(e, s),
          ...
          getTicksAtTime(t) {
            ...
            let o = n || s,
              ...
              a = null;
            return (
              this._state.forEachBetween(o.time, e + this.sampleTime, (t) => {
                let e = o.time;
                ...
                s && s.time >= o.time && ((r = s.ticks), (e = s.time)),
                  "started" === o.state &&
                    ...
                    t.time !== i.time &&
                      (a = { state: t.state, time: t.time, ticks: r })),
                  (o = t);
              }),
          ...
          getSecondsAtTime(t) {
            ...
            let i = n || e,
              ...
              r = null;
            return (
              this._state.forEachBetween(i.time, t + this.sampleTime, (t) => {
                let e = i.time;
                ...
                n && n.time >= i.time && ((o = n.seconds), (e = n.time)),
                  "started" === i.state &&
                    ...
                    ((o += t.time - e),
                    t.time !== s.time &&
                      (r = { state: t.state, time: t.time, seconds: o })),
                  (i = t);
              }),
        ...
        class xo extends io {
          ...
          static getDefaults() {
            return Object.assign(io.getDefaults(), { mute: !1, volume: 0 });
          }
          get mute() {
        ...
        class wo extends io {
          constructor() {
            ...
            super(t),
              ...
              (this.input = new xo({ context: this.context })),
              (this.output = new ho({ context: this.context })),
        ...
        function To(t, e) {
          return ni(
            ...
            arguments,
            void 0,
            function* (t, e, s = 2, n = Vi().sampleRate) {
              const i = Vi(),
                o = new qi(s, e, n);
              Ni(o), yield t(o);
              const r = o.render();
        ...
        class So extends fi {
          ...
          get(t) {
            return (
              Bn(this.has(t), `ToneAudioBuffers has no buffer named: ${t}`),
          ...
          add(t, e, s = Ei, n = Ei) {
            return (
              zn(e)
                ? (this.baseUrl &&
                    "data:audio/" === e.trim().substring(0, 11).toLowerCase() &&
                    (this.baseUrl = ""),
                  this._buffers.set(
                    t.toString(),
                    new Ri(this.baseUrl + e, s, n)
                  ))
                : this._buffers.set(t.toString(), new Ri(e, s, n)),
              this
            );
          }
          dispose() {
        ...
        class Mo extends fi {
          ...
          add(t) {
            Bn(Fn(t.time), "Events must have a time property"),
              Bn(Fn(t.duration), "Events must have a duration parameter"),
              (t.time = t.time.valueOf());
        ...
        class Ro extends fi {
          constructor(t) {
            super(),
              ...
              (this._timeline = new wi({ memory: 10 })),
        ...
        class Io extends qo {
          constructor() {
            ...
            super(t),
              ...
              Ln(t.mapping) || t.mapping instanceof Float32Array
                ? (this.curve = Float32Array.from(t.mapping))
                : Vn(t.mapping) && this.setMap(t.mapping, t.length);
          }
          static getDefaults() {
        ...
        class Vo {
          ...
          static getDefaults() {
            return { callback: Ei, once: !1, time: 0 };
          }
          get floatTime() {
        ...
        class No extends Vo {
          ...
          _createEvent() {
            return vi(this._nextTick, this.floatTime + this.duration)
              ? this.transport.scheduleOnce(
                  this.invoke.bind(this),
                  new Co(this.context, this._nextTick).toSeconds()
                )
              : -1;
          }
          _createEvents(t) {
          ...
          _restart(t) {
            ...
            mi(e, this.time) &&
              (this._nextTick =
                this.floatTime +
                Math.ceil((e - this.floatTime) / this._interval) *
                  this._interval),
        ...
        class Po extends eo {
          ...
          _processTick(t, e) {
            if (
              ...
              t +=
                new Co(this.context, (2 * this._swingTicks) / 3).toSeconds() *
                n;
            }
          ...
          _bindClockEvents() {
            this._clock.on("start", (t, e) => {
              (e = new Co(this.context, e).toSeconds()),
                this.emit("start", t, e);
            }),
            ...
            if (this._clock.ticks !== t) {
              ...
              if ("started" === this.state) {
                const s = this._clock.getTicksAtTime(e),
                  n =
                    e +
                    this._clock.frequency.getDurationOfTicks(
                      Math.ceil(s) - s,
                      e
                    );
                this.emit("stop", n),
        ...
        class jo extends io {
          ...
          start(t, e, s) {
            ...
            if (
              ...
              if (
                ...
                t &&
                  ((t.offset = this.toSeconds(pi(e, 0))),
          ...
          stop(t) {
            ...
            if (
              ...
              "started" === this._state.getValueAtTime(e) ||
                Fn(this._state.getNextState("started", e)))
            ) {
        ...
        class zo extends jo {
          ...
          set type(t) {
            if (
              (Bn(t in Uo, "Noise: invalid type: " + t),
        ...
        const Wo = 220500,
          Bo = { brown: null, pink: null, white: null },
          Uo = {
            get brown() {
              if (!Bo.brown) {
                const t = [];
        ...
        class Go extends io {
          constructor() {
            ...
            super(t),
              (this.name = "UserMedia"),
              (this._volume = this.output =
                new xo({ context: this.context, volume: t.volume })),
              (this.volume = this._volume.volume),
              Di(this, "volume"),
              (this.mute = t.mute);
          }
          ...
          open(t) {
            return ni(this, void 0, void 0, function* () {
              Bn(Go.supported, "UserMedia is not supported"),
              ...
              Nn(t)
                ...
                : ((this._device = e.find(
                  ...
                  Bn(Fn(this._device), `No matching device ${t}`));
              const s = {
                audio: {
                  echoCancellation: !1,
        ...
        class Xo extends jo {
          ...
          _getCachedPeriodicWave() {
            if ("custom" === this._type)
              return Xo._periodicWaveCache.find((t) => {
                return (
                  t.phase === this._phase &&
                  ((e = t.partials),
                  (s = this._partials),
            ...
            {
              const t = Xo._periodicWaveCache.find(
            ...
            if (0 === this._phase && e)
              ...
              if (Fn(e)) {
                ...
                (this._wave = n),
                  ...
                  Xo._periodicWaveCache.length > 100 &&
                    Xo._periodicWaveCache.shift();
              }
            }
          }
          get baseType() {
          ...
          _getRealImaginary(t, e) {
            ...
            for (let r = 1; r < s; ++r) {
              ...
              0 !== a
                ? ((n[r] = -a * Math.sin(e * r)), (i[r] = a * Math.cos(e * r)))
                : ((n[r] = 0), (i[r] = 0));
            }
            return [n, i];
          }
        ...
        class Ho extends jo {
          constructor() {
            ...
            super(t),
              ...
              (this._modulationScale = new Yo({ context: this.context })),
              (this._modulationNode = new ho({ context: this.context })),
              ...
              Di(this, ["frequency", "detune", "harmonicity"]);
          }
          static getDefaults() {
        ...
        class Ko extends jo {
          constructor() {
            ...
            super(t),
              ...
              (this._widthGate = new ho({ context: this.context, gain: 0 })),
              (this._thresh = new Io({
                context: this.context,
                mapping: (t) => (t <= 0 ? -1 : 1),
              })),
              ...
              Di(this, ["width", "frequency", "detune"]);
          }
          static getDefaults() {
            return Object.assign(jo.getDefaults(), {
              detune: 0,
        ...
        class er extends jo {
          constructor() {
            ...
            super(t),
              ...
              (this.sourceType = "pwm"),
              (this._scale = new $o({ context: this.context, value: 2 })),
              (this._pulse = new Ko({
                context: this.context,
              ...
              Di(this, ["modulationFrequency", "frequency", "detune"]);
          }
          static getDefaults() {
            return Object.assign(jo.getDefaults(), {
              detune: 0,
        ...
        class ir extends po {
          constructor() {
            super(ui(ir.getDefaults(), arguments, ["value"])),
              (this.override = !1),
              (this.name = "Add"),
              (this._sum = new ho({ context: this.context })),
          ...
          constructor() {
            ...
            super(t),
              ...
              (this._mult = this.input =
                new $o({ context: this.context, value: t.max - t.min })),
              (this._add = this.output =
                new ir({ context: this.context, value: t.min })),
              (this._min = t.min),
              (this._max = t.max),
        ...
        class rr extends qo {
          constructor() {
            super(ui(rr.getDefaults(), arguments)),
              (this.name = "Zero"),
              (this._gain = new ho({ context: this.context })),
          ...
          dispose() {
            return (
              super.dispose(), ao(this.context.getConstant(0), this._gain), this
            );
          }
        }
        class ar extends io {
          constructor() {
            ...
            super(t),
              ...
              (this._zeros = new rr({ context: this.context })),
              (this._a2g = new Yo({ context: this.context })),
              (this._scaler = this.output =
                new or({ context: this.context, max: t.max, min: t.min })),
              (this.units = t.units),
              (this.min = t.min),
              (this.max = t.max),
          ...
          connect(t, e, s) {
            return (
              (t instanceof no || t instanceof po) &&
        ...
        class lr extends jo {
          ...
          _start(t, e, s) {
            ...
            this._loop ||
              ...
              this._loop && In(i)
                ? r.start(t, n)
                : r.start(t, n, o - this.toSeconds(this.fadeOut));
          }
          _stop(t) {
            const e = this.toSeconds(t);
          ...
          _restart(t, e, s) {
            var n;
            null === (n = [...this._activeSources].pop()) ||
              void 0 === n ||
              n.stop(t),
              this._start(t, e, s);
          }
          ...
          set loopStart(t) {
            (this._loopStart = t),
              this.buffer.loaded &&
                Un(this.toSeconds(t), 0, this.buffer.duration),
        ...
        si([hr(0)], lr.prototype, "fadeIn", void 0),
          si([hr(0)], lr.prototype, "fadeOut", void 0);
        class ur extends io {
          constructor() {
            const t = ui(
              ur.getDefaults(),
        ...
        class _r extends qo {
          constructor() {
            super(...arguments),
              (this.name = "Negate"),
              (this._multiply = new $o({ context: this.context, value: -1 })),
        ...
        class mr extends po {
          constructor() {
            super(ui(mr.getDefaults(), arguments, ["value"])),
              (this.override = !1),
              (this.name = "Subtract"),
              (this._sum = new ho({ context: this.context })),
              (this.input = this._sum),
              (this.output = this._sum),
              (this._neg = new _r({ context: this.context })),
          ...
          constructor() {
            super(ui(gr.getDefaults(), arguments)),
              ...
              (this._scale = this.input =
                new $o({ context: this.context, value: 1e4 })),
          ...
          constructor() {
            ...
            super(t),
              ...
              (this._subtract = this.input =
                new mr({ context: this.context, value: t.value })),
              (this._gtz = this.output = new gr({ context: this.context })),
          ...
          constructor() {
            ...
            super(t),
              ...
              (this.input = this._exp =
                new Fo({ context: this.context, value: t.exponent })),
        ...
        class wr extends io {
          constructor() {
            const t = ui(wr.getDefaults(), arguments, [
              "attack",
              "decay",
              "sustain",
              "release",
            ...
            super(t),
              (this.name = "Envelope"),
              (this._sig = new po({ context: this.context, value: 0 })),
          ...
          triggerAttack(t, e = 1) {
            ...
            if ((i > 0 && (s = (1 - i) / (1 / s)), s < this.sampleTime))
            ...
            if (n && this.sustain < 1) {
              ...
              this.log("decay", o),
                "linear" === this._decayCurve
                  ? this._sig.linearRampToValueAtTime(i, n + o)
                  : this._sig.exponentialApproachValueAtTime(i, o, n);
            }
            return this;
          }
          triggerRelease(t) {
        ...
        si([hr(0)], wr.prototype, "attack", void 0),
          si([hr(0)], wr.prototype, "decay", void 0),
          si([cr(0, 1)], wr.prototype, "sustain", void 0),
          si([hr(0)], wr.prototype, "release", void 0);
        const br = (() => {
          const t = 128;
          let e, s;
          const n = [];
          ...
          const r = [];
          for (e = 0; e < t; e++)
            (s = e / 127), (r[e] = 0.5 * (1 - Math.cos(Math.PI * s)));
          const a = [];
          for (e = 0; e < t; e++) {
            s = e / 127;
          ...
          return {
            bounce: { In: c(a), Out: a },
            cosine: { In: n, Out: ((h = n), h.slice(0).reverse()) },
        ...
        class Tr extends io {
          ...
          triggerAttackRelease(t, e, s, n) {
            const i = this.toSeconds(s),
              o = this.toSeconds(e);
            return (
              this.triggerAttack(t, i, n), this.triggerRelease(i + o), this
            );
          }
          dispose() {
            return (
        ...
        class kr extends wr {
          constructor() {
            super(
              ...
              (this._gainNode = new ho({ context: this.context, gain: 0 })),
              (this.output = this._gainNode),
              (this.input = this._gainNode),
          ...
          static getDefaults() {
            return Object.assign(Sr.getDefaults(), {
              ...
              modulationEnvelope: Object.assign(
                di(wr.getDefaults(), Object.keys(io.getDefaults())),
                { attack: 0.5, decay: 0, sustain: 1, release: 0.5 }
              ),
            });
          }
          _triggerEnvelopeAttack(t, e) {
        ...
        class Mr extends io {
          constructor() {
            ...
            super(t),
              (this.name = "Filter"),
              (this.input = new ho({ context: this.context })),
              (this.output = new ho({ context: this.context })),
              (this._filters = []),
              (this._filters = []),
              (this.Q = new po({
              ...
              Di(this, ["detune", "frequency", "gain", "Q"]);
          }
          static getDefaults() {
            return Object.assign(io.getDefaults(), {
              Q: 1,
          ...
          dispose() {
            return (
              ...
              Mi(this, ["detune", "frequency", "gain", "Q"]),
              this.frequency.dispose(),
              this.Q.dispose(),
              this.detune.dispose(),
              this.gain.dispose(),
        ...
        class Rr extends Sr {
          constructor() {
            ...
            super(t),
              ...
              (this.detune = this.oscillator.detune),
              (this.filter = new Mr(
                Object.assign(t.filter, { context: this.context })
              )),
              (this.filterEnvelope = new Er(
                Object.assign(t.filterEnvelope, { context: this.context })
              )),
              (this.envelope = new kr(
                Object.assign(t.envelope, { context: this.context })
              )),
          ...
          static getDefaults() {
            return Object.assign(Sr.getDefaults(), {
              envelope: Object.assign(
                di(wr.getDefaults(), Object.keys(io.getDefaults())),
                { attack: 0.005, decay: 0.1, release: 1, sustain: 0.9 }
              ),
              filter: Object.assign(
                di(Mr.getDefaults(), Object.keys(io.getDefaults())),
                { Q: 1, rolloff: -12, type: "lowpass" }
              ),
              filterEnvelope: Object.assign(
                di(Er.getDefaults(), Object.keys(io.getDefaults())),
                {
                  attack: 0.6,
                  baseFrequency: 200,
                  decay: 0.2,
              ...
              oscillator: Object.assign(
                di(nr.getDefaults(), Object.keys(jo.getDefaults())),
                { type: "sawtooth" }
              ),
            });
          }
        ...
        class qr extends Sr {
          constructor() {
            ...
            super(t),
              ...
              (this.voice1 = new Rr(
                Object.assign(t.voice1, { context: this.context })
              )),
              (this.harmonicity = new $o({
                context: this.context,
                units: "positive",
        ...
        class Vr extends Sr {
          ...
          static getDefaults() {
            return li(Sr.getDefaults(), {
              envelope: Object.assign(
                di(wr.getDefaults(), Object.keys(io.getDefaults())),
                { attack: 0.001, decay: 1.4, release: 0.2 }
              ),
              harmonicity: 5.1,
              modulationIndex: 32,
              octaves: 1.5,
        ...
        class Nr extends Ar {
          ...
          setNote(t, e) {
            const s = this.toSeconds(e),
              ...
              i = n * this.octaves;
            return (
              this.oscillator.frequency.setValueAtTime(i, s),
        ...
        si([cr(0)], Nr.prototype, "octaves", void 0),
          si([hr(0)], Nr.prototype, "pitchDecay", void 0);
        class Pr extends Tr {
          constructor() {
            ...
            super(t),
              ...
              (this.noise = new zo(
                Object.assign({ context: this.context }, t.noise)
              )),
              (this.envelope = new kr(
                Object.assign({ context: this.context }, t.envelope)
              )),
          ...
          static getDefaults() {
            return Object.assign(Tr.getDefaults(), {
              ...
              noise: Object.assign(
                di(zo.getDefaults(), Object.keys(jo.getDefaults())),
                { type: "white" }
              ),
            });
          }
        ...
        class Zr extends Tr {
          constructor() {
            ...
            super(t),
              ...
              (this._noise = new zo({ context: this.context, type: "pink" })),
        ...
        class Xr extends Tr {
          ...
          _getNextAvailableVoice() {
            ...
            if (this._voices.length < this.maxPolyphony) {
              ...
              return (
                Bn(t instanceof Sr, "Voice must extend Monophonic class"),
          ...
          _triggerAttack(t, e, s) {
            t.forEach((t) => {
              ...
              i &&
                (i.triggerAttack(t, e, s),
                this._activeVoices.push({ midi: n, voice: i, released: !1 }),
            ...
            t.forEach((t) => {
              const s = new ko(this.context, t).toMidi(),
                n = this._activeVoices.find(
                  ({ midi: t, released: e }) => t === s && !e
                );
              n &&
                (n.voice.triggerRelease(e),
                (n.released = !0),
          ...
          set(t) {
            ...
            return (
              (this.options = li(this.options, e)),
        ...
        class Yr extends Tr {
          ...
          triggerRelease(t, e) {
            return (
              ...
              t.forEach((t) => {
                ...
                if (
                  this._activeSources.has(s) &&
                  this._activeSources.get(s).length
                ) {
          ...
          triggerAttackRelease(t, e, s, n = 1) {
            ...
            return (
              ...
              Ln(e)
                ? (Bn(Ln(t), "notes must be an array when duration is array"),
                  t.forEach((t, s) => {
                    const n = e[Math.min(s, e.length - 1)];
          ...
          add(t, e, s) {
            if (
              (Bn(Wn(t) || isFinite(t), `note must be a pitch or midi: ${t}`),
              Wn(t))
            ) {
        ...
        si([hr(0)], Yr.prototype, "attack", void 0),
          si([hr(0)], Yr.prototype, "release", void 0);
        class $r extends eo {
          constructor() {
        ...
        class Jr extends $r {
            ...
            (e -= s),
              this._loop
                ? t.startOffset >= this._loopStart &&
                  ...
                  ? (t.startOffset < s && (e += this._getLoopDuration()),
                    t.start(new Co(this.context, e)))
                  : t.startOffset < this._loopStart &&
                    t.startOffset >= s &&
                    ((t.loop = !1), t.start(new Co(this.context, e)))
                : t.startOffset >= s && t.start(new Co(this.context, e));
          }
          get startOffset() {
            return this._startOffset;
          }
          ...
          add(t, e) {
            ...
            return (
              e instanceof $r
                ? ((n = e), (n.callback = this._tick.bind(this)))
                : (n = new $r({
                    callback: this._tick.bind(this),
                    context: this.context,
                    value: e,
          ...
          _restartEvent(t) {
            this._state.forEach((e) => {
              "started" === e.state
                ...
                : t.stop(new Co(this.context, e.time));
            });
          }
          remove(t, e) {
            return (
              Pn(t) && t.hasOwnProperty("time") && (t = (e = t).time),
              (t = this.toTicks(t)),
              this._events.forEach((s) => {
                s.startOffset === t &&
                  (In(e) || (Fn(e) && s.value === e)) &&
                  (this._events.delete(s), s.dispose());
              }),
              this
            );
          }
          clear() {
            return (
              this._forEach((t) => t.dispose()), this._events.clear(), this
            );
          }
          cancel(t) {
            return (
        ...
        function* na(t) {
          let e = 0,
            s = 0;
          for (; e < t; )
            (e = xi(e, 0, t - 1)), yield e, s++, (e += s % 2 ? 2 : -1);
        }
        function* ia(t) {
          let e = t - 1,
            s = 0;
        ...
        function* oa(t) {
          ...
          for (; e.length > 0; ) {
            const s = xi(
              e.splice(Math.floor(e.length * Math.random()), 1)[0],
              0,
              t - 1
            );
            yield s;
        ...
        function* ra(t, e = "up", s = 0) {
          switch (
            (Bn(t >= 1, "The number of values must be at least one"), e)
          ) {
            case "up":
              yield* ea(t, Kr);
            case "down":
        ...
        class aa extends Hr {
          constructor() {
            ...
            super(t),
              ...
              (this._pattern = ra(t.values.length, t.pattern)),
          ...
          set pattern(t) {
            (this._type = t),
              (this._pattern = ra(this._values.length, this._type));
          }
        }
        class ca extends $r {
          constructor() {
          ...
          _createSequence(t) {
            return new Proxy(t, {
              get: (t, e) => t[e],
              set: (t, e, s) => (
                zn(e) && isFinite(parseInt(e, 10)) && Ln(s)
                  ? (t[e] = this._createSequence(s))
                  : (t[e] = s),
                this._eventsUpdated(),
                !0
              ),
        ...
        class ha extends io {
          constructor() {
            ...
            super(t),
              ...
              (this._g2a = new fr({ context: this.context })),
              (this.a = new ho({ context: this.context, gain: 0 })),
              (this.b = new ho({ context: this.context, gain: 0 })),
              (this.output = new ho({ context: this.context })),
        ...
        class la extends io {
          constructor(t) {
            super(t),
              (this.name = "Effect"),
              (this._dryWet = new ha({ context: this.context })),
              (this.wet = this._dryWet.fade),
              (this.effectSend = new ho({ context: this.context })),
              (this.effectReturn = new ho({ context: this.context })),
              (this.input = new ho({ context: this.context })),
        ...
        class _a extends io {
          constructor() {
            ...
            super(t),
              (this.name = "Follower"),
              (this._abs = this.input = new dr({ context: this.context })),
        ...
        class ma extends la {
          constructor() {
            const t = ui(ma.getDefaults(), arguments, [
              "baseFrequency",
              "octaves",
              "sensitivity",
            ]);
            super(t),
              ...
              (this._baseFrequency = this.toFrequency(t.baseFrequency)),
              (this._octaves = t.octaves),
              (this._inputBoost = new ho({ context: this.context })),
        ...
        class va extends la {
          constructor() {
            ...
            super(t),
              ...
              (this._bitCrusherWorklet = new ya({
                context: this.context,
                bits: t.bits,
              })),
        ...
        class xa extends la {
          constructor() {
            ...
            super(t),
              (this.name = "Chebyshev"),
              (this._shaper = new Io({ context: this.context, length: 4096 })),
              (this._order = t.order),
            ...
            return (
              s.has(e) ||
                (0 === e
                  ...
                  : s.set(
                      e,
                      2 * t * this._getCoefficient(t, e - 1, s) -
                        this._getCoefficient(t, e - 2, s)
                    )),
              s.get(e)
            );
          }
          ...
          constructor(t) {
            super(t),
              ...
              (this._dryWet = this.output =
                new ha({ context: this.context, fade: t.wet })),
              (this.wet = this._dryWet.fade),
              (this._split = new wa({ context: this.context, channels: 2 })),
              (this._merge = new ba({ context: this.context, channels: 2 })),
        ...
        class Sa extends Ta {
          constructor(t) {
            super(t),
              ...
              (this._feedbackL = new ho({ context: this.context })),
              (this._feedbackR = new ho({ context: this.context })),
        ...
        class ka extends Sa {
          constructor() {
            ...
            super(t),
              ...
              (this._delayNodeL = new yo({ context: this.context })),
              (this._delayNodeR = new yo({ context: this.context })),
        ...
        class Aa extends la {
          ...
          set distortion(t) {
            ...
            this._shaper.setMap((t) =>
              Math.abs(t) < 0.001
                ? 0
                : ((3 + e) * t * 20 * s) / (Math.PI + e * Math.abs(t))
            );
          }
          get oversample() {
            return this._shaper.oversample;
        ...
        class Da extends io {
          constructor(t) {
            super(t),
              ...
              (this.input = new ho({ context: this.context })),
              (this.output = new ho({ context: this.context })),
              (this.offset90 = new ho({ context: this.context })),
              ...
              (this._bank1 = this._createAllPassFilterBank([
                0.4021921162426, 0.856171088242, 0.9722909545651,
                0.9952884791278,
              ])),
        ...
        class Ma extends la {
          constructor() {
            ...
            super(t),
              ...
              (this._sine = new Zo({ context: this.context, type: "sine" })),
              (this._cosine = new Xo({
                context: this.context,
                phase: -90,
                type: "sine",
              })),
              (this._sineMultiply = new $o({ context: this.context })),
              (this._cosineMultiply = new $o({ context: this.context })),
              (this._negate = new _r({ context: this.context })),
              (this._add = new ir({ context: this.context })),
              (this._phaseShifter = new Da({ context: this.context })),
          ...
          constructor() {
            ...
            super(t),
              ...
              (this._combFilters = Ea.map((e, s) => {
                ...
                return (
                  s < Ea.length / 2
                    ? this.connectEffectLeft(n, ...this._allpassFiltersL)
                    : this.connectEffectRight(n, ...this._allpassFiltersR),
        ...
        const Ia = [0.06748, 0.06404, 0.08212, 0.09004],
          Fa = [0.773, 0.802, 0.753, 0.733],
          Va = [347, 113, 37];
        class Na extends Ta {
          constructor() {
            ...
            super(t),
              ...
              (this._feedbackCombFilters = Ia.map((t, e) => {
                ...
                return (
                  ...
                  e < Ia.length / 2
                    ? this.connectEffectLeft(...this._allpassFilters, s)
                    : this.connectEffectRight(...this._allpassFilters, s),
                  s
                );
              })),
        ...
        class La extends Ca {
          constructor() {
            ...
            super(t),
              ...
              (this._frequency = new po({ context: this.context })),
              (this._delayA = new yo({ maxDelay: 1, context: this.context })),
              (this._lfoA = new ar({
                context: this.context,
                min: 0,
                max: 0.1,
              ...
              (this._delayB = new yo({ maxDelay: 1, context: this.context })),
              (this._lfoB = new ar({
                context: this.context,
                min: 0,
                max: 0.1,
              ...
              (this._crossFade = new ha({ context: this.context })),
          ...
          constructor() {
            super(ui(Ba.getDefaults(), arguments)),
              ...
              (this._split = this.input =
                new wa({ channels: 2, context: this.context })),
              (this._midAdd = new ir({ context: this.context })),
              (this.mid = new $o({
                context: this.context,
                value: Math.SQRT1_2,
              })),
              (this._sideSubtract = new mr({ context: this.context })),
              (this.side = new $o({
                context: this.context,
                value: Math.SQRT1_2,
              })),
        ...
        class Ua extends io {
          constructor() {
            super(ui(Ua.getDefaults(), arguments)),
              ...
              (this.mid = new ho({ context: this.context })),
              (this.side = new ho({ context: this.context })),
              (this._left = new ir({ context: this.context })),
              (this._leftMult = new $o({
                context: this.context,
                value: Math.SQRT1_2,
              })),
              (this._right = new mr({ context: this.context })),
              (this._rightMult = new $o({
                context: this.context,
                value: Math.SQRT1_2,
              })),
              (this._merge = this.output = new ba({ context: this.context })),
        ...
        class Ga extends la {
          constructor(t) {
            super(t),
              ...
              (this._midSideMerge = new Ua({ context: this.context })),
              (this._midSideSplit = new Ba({ context: this.context })),
        ...
        class Qa extends Ga {
          constructor() {
            ...
            super(t),
              ...
              (this._midMult = new $o({ context: this.context })),
              this._twoTimesWidthMid.connect(this._midMult.factor),
              this.connectEffectMid(this._midMult),
              (this._oneMinusWidth = new mr({ context: this.context })),
              this._oneMinusWidth.connect(this._twoTimesWidthMid),
              ro(this.context.getConstant(1), this._oneMinusWidth),
              this.width.connect(this._oneMinusWidth.subtrahend),
              (this._sideMult = new $o({ context: this.context })),
        ...
        class Za extends Ta {
          constructor() {
            ...
            super(t),
              ...
              (this._amplitudeL = new ho({ context: this.context })),
              (this._amplitudeR = new ho({ context: this.context })),
              (this.frequency = new po({
                context: this.context,
                value: t.frequency,
                units: "frequency",
          ...
          getValue() {
            return (
              this._analysers.forEach((t, e) => {
                ...
                "fft" === this._type
                  ? t.getFloatFrequencyData(s)
                  : "waveform" === this._type && t.getFloatTimeDomainData(s);
              }),
        ...
        class Ha extends $a {
          ...
          getLevel() {
            return (
              Kn("'getLevel' has been changed to 'getValue'"), this.getValue()
            );
          }
          getValue() {
            const t = this._analyser.getValue(),
              e = (1 === this.channels ? [t] : t).map((t, e) => {
                ...
                return (
                  (this._rms[e] = Math.max(n, this._rms[e] * this.smoothing)),
        ...
        class ec extends io {
          constructor() {
            ...
            super(t),
              (this.name = "Solo"),
              (this.input = this.output = new ho({ context: this.context })),
              ec._allSolos.has(this.context) ||
                ec._allSolos.set(this.context, new Set()),
              ec._allSolos.get(this.context).add(this),
              (this.solo = t.solo);
          }
          static getDefaults() {
            return Object.assign(io.getDefaults(), { solo: !1 });
          }
          get solo() {
          ...
          set solo(t) {
            t ? this._addSolo() : this._removeSolo(),
              ec._allSolos.get(this.context).forEach((t) => t._updateSolo());
          }
          get muted() {
            return 0 === this.input.gain.value;
          }
          _addSolo() {
            ec._soloed.has(this.context) ||
              ec._soloed.set(this.context, new Set()),
              ec._soloed.get(this.context).add(this);
          }
          _removeSolo() {
            ec._soloed.has(this.context) &&
              ec._soloed.get(this.context).delete(this);
          }
          _isSoloed() {
            return (
              ec._soloed.has(this.context) &&
              ec._soloed.get(this.context).has(this)
            );
          }
          _noSolos() {
            return (
              !ec._soloed.has(this.context) ||
              (ec._soloed.has(this.context) &&
                0 === ec._soloed.get(this.context).size)
            );
          }
          _updateSolo() {
          ...
          dispose() {
            return (
              super.dispose(),
              ec._allSolos.get(this.context).delete(this),
              this._removeSolo(),
              this
            );
          }
        ...
        class nc extends io {
          constructor() {
            ...
            super(t),
              ...
              (this._solo = this.input =
                new ec({ solo: t.solo, context: this.context })),
          ...
          _getBus(t) {
            return (
              nc.buses.has(t) ||
                nc.buses.set(t, new ho({ context: this.context })),
              nc.buses.get(t)
            );
          }
          send(t, e = 0) {
          ...
          constructor() {
            super(ui(ic.getDefaults(), arguments)),
              ...
              (this._merge = this.output =
                new ba({ channels: 2, context: this.context })),
              this.input.connect(this._merge, 0, 0),
              this.input.connect(this._merge, 0, 1);
          }
          dispose() {
            return (
              super.dispose(), this._merge.dispose(), this.input.dispose(), this
            );
          }
        }
        class oc extends io {
          constructor() {
            const t = ui(oc.getDefaults(), arguments, [
              "lowFrequency",
              "highFrequency",
            ]);
            super(t),
              ...
              Di(this, ["high", "mid", "low", "highFrequency", "lowFrequency"]);
          }
          static getDefaults() {
            return Object.assign(io.getDefaults(), {
              Q: 1,
          ...
          dispose() {
            return (
              super.dispose(),
              Mi(this, ["high", "mid", "low", "highFrequency", "lowFrequency"]),
              this.low.dispose(),
        ...
        class ac extends io {
          ...
          pause() {
            return (
              Bn("started" === this.state, "Recorder must be started"),
        ...
        class hc extends io {
          constructor() {
            ...
            super(t),
              ...
              (this.input = new ho({ context: this.context })),
              (this._gate = this.output = new ho({ context: this.context })),
          ...
          constructor() {
            ...
            super(t),
              ...
              (this._midSideSplit = this.input =
                new Ba({ context: this.context })),
              (this._midSideMerge = this.output =
                new Ua({ context: this.context })),
              (this.mid = new cc(
                Object.assign(t.mid, { context: this.context })
              )),
              (this.side = new cc(
                Object.assign(t.side, { context: this.context })
              )),
        ...
        class pc extends io {
          constructor() {
            ...
            super(t),
              ...
              (this.output = new ho({ context: this.context })),
              (this.low = new cc(
                Object.assign(t.low, { context: this.context })
              )),
              (this.mid = new cc(
                Object.assign(t.mid, { context: this.context })
              )),
              (this.high = new cc(
                Object.assign(t.high, { context: this.context })
              )),
        ...
        class dc extends io {
          constructor() {
            ...
            super(t),
              ...
              Di(this, ["low", "mid", "high", "lowFrequency", "highFrequency"]),
          ...
          dispose() {
            return (
              super.dispose(),
              Mi(this, ["low", "mid", "high", "lowFrequency", "highFrequency"]),
